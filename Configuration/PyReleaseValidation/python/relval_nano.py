...
steps['STDNANO_mc15.0'] = merge([{'-s': 'PAT,NANO', '-n': '1000'},
                                 steps['NANO_mc15.0']])
...
lumis_Run2025C_EGamma2 = {392925: [[268, 703]]}
...
steps['EGamma2_Run2025C_AOD_150X'] = {'INPUT': InputInfo(
    location='STD',ls=lumis_Run2025C_Muon0, dataSet='/EGamma2/Run2025C-PromptReco-v1/AOD')}
...
steps['STDNANO_data15.0'] = merge([{'-s': 'PAT,NANO', '-n': '1000'},
                                   steps['NANO_data15.0']])
...
workflows[_wfn()] = ['STDNANOmc150X', ['TTbar_13p6_Summer24_AOD_140X', 'STDNANO_mc15.0']]
...
workflows[_wfn()] = ['STDNANOdata150Xrun3', ['Muon0_Run2025C_AOD_150X', 'STDNANO_data15.0']]
workflows[_wfn()] = ['EXONANOdata150Xrun3EGamma', ['EGamma2_Run2025C_AOD_150X', 'EXONANO_data15.0']]
workflows[_wfn()] = ['STDNANOdata150Xrun3EGamma', ['EGamma2_Run2025C_AOD_150X', 'STDNANO_data15.0']]
