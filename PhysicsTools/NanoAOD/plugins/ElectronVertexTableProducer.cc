...
void ElectronVertexTableProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
  ...
  vertexTab->addColumn<float>("isValid", vertexIsValid, "", precision_);
  vertexTab->addColumn<float>("vxy", vxy, "", precision_);
  vertexTab->addColumn<float>("vxySigma", vxySigma, "", precision_);
  vertexTab->addColumn<float>("vxyz", vxyz, "", precision_);
  vertexTab->addColumn<float>("vxyzSigma", vxyzSigma, "", precision_);
  vertexTab->addColumn<float>("chi2", chi2, "", precision_);
  vertexTab->addColumn<float>("ndof", ndof, "", precision_);
  vertexTab->addColumn<float>("normChi2", normChi2, "", precision_);
  vertexTab->addColumn<float>("vx", vx, "", precision_);
  vertexTab->addColumn<float>("vy", vy, "", precision_);
  vertexTab->addColumn<float>("vz", vz, "", precision_);
  vertexTab->addColumn<float>("t", t, "", precision_);
  vertexTab->addColumn<float>("vxErr", vxErr, "", precision_);
  vertexTab->addColumn<float>("vyErr", vyErr, "", precision_);
  vertexTab->addColumn<float>("vzErr", vzErr, "", precision_);
  vertexTab->addColumn<float>("tErr", tErr, "", precision_);
  vertexTab->addColumn<float>("dR", dR, "", precision_);
  vertexTab->addColumn<float>("originalElectronIdx1", originalElectronIdx1, "", precision_);
  vertexTab->addColumn<float>("originalElectronIdx2", originalElectronIdx2, "", precision_);
  vertexTab->addColumn<float>("dca", DCA, "", precision_);
  vertexTab->addColumn<float>("dcaStatus", DCAstatus, "", precision_);
  vertexTab->addColumn<float>("dcax", DCAx, "", precision_);
  vertexTab->addColumn<float>("dcay", DCAy, "", precision_);
  vertexTab->addColumn<float>("dcaz", DCAz, "", precision_);
  vertexTab->addColumn<float>("hitsInFrontOfVert1", hitsInFrontOfVert1, "", precision_);
  vertexTab->addColumn<float>("hitsInFrontOfVert2", hitsInFrontOfVert2, "", precision_);
  vertexTab->addColumn<float>("missHitsAfterVert1", missHitsAfterVert1, "", precision_);
  vertexTab->addColumn<float>("missHitsAfterVert2", missHitsAfterVert2, "", precision_);
  vertexTab->addColumn<float>("refittedTrackIdx1", refittedTrackIdx1, "", precision_);
  vertexTab->addColumn<float>("refittedTrackIdx2", refittedTrackIdx2, "", precision_);
  vertexTab->addColumn<float>("massRefit", refittedVertMass, "", precision_);
  vertexTab->addColumn<float>("ptRefit", refittedVertPt, "", precision_);
  vertexTab->addColumn<float>("etaRefit", refittedVertEta, "", precision_);
  vertexTab->addColumn<float>("phiRefit", refittedVertPhi, "", precision_);

  iEvent.put(std::move(vertexTab), "ElectronVertex");

  refittedTracksTab->addColumn<float>("idx", refittedTrackIdx, "", precision_);
  refittedTracksTab->addColumn<float>("originalElectronIdx", refittedTrackOriginalIdx, "", precision_);
  refittedTracksTab->addColumn<float>("pt", refittedTrackPt, "", precision_);
  refittedTracksTab->addColumn<float>("ptErr", refittedTrackPtErr, "", precision_);
  refittedTracksTab->addColumn<float>("px", refittedTrackPx, "", precision_);
  refittedTracksTab->addColumn<float>("py", refittedTrackPy, "", precision_);
  refittedTracksTab->addColumn<float>("pz", refittedTrackPz, "", precision_);
  refittedTracksTab->addColumn<float>("eta", refittedTrackEta, "", precision_);
  refittedTracksTab->addColumn<float>("etaErr", refittedTrackEtaErr, "", precision_);
  refittedTracksTab->addColumn<float>("phi", refittedTrackPhi, "", precision_);
  refittedTracksTab->addColumn<float>("phiErr", refittedTrackPhiErr, "", precision_);
  refittedTracksTab->addColumn<float>("charge", refittedTrackCharge, "", precision_);
  refittedTracksTab->addColumn<float>("normChi2", refittedTrackNormChi2, "", precision_);
  refittedTracksTab->addColumn<float>("ndof", refittedTrackNdof, "", precision_);
  refittedTracksTab->addColumn<float>("chi2", refittedTrackChi2, "", precision_);
  refittedTracksTab->addColumn<float>("dzPV", refittedTrackDzPV, "", precision_);
  refittedTracksTab->addColumn<float>("dzPVErr", refittedTrackDzPVErr, "", precision_);
  refittedTracksTab->addColumn<float>("dxyPVTraj", refittedTrackDxyPVTraj, "", precision_);
  refittedTracksTab->addColumn<float>("dxyPVTrajErr", refittedTrackDxyPVTrajErr, "", precision_);
  refittedTracksTab->addColumn<float>("dxyPVSigned", refittedTrackDxyPVSigned, "", precision_);
  refittedTracksTab->addColumn<float>("dxyPVSignedErr", refittedTrackDxyPVSignedErr, "", precision_);
  refittedTracksTab->addColumn<float>("ip3DPVSigned", refittedTrackIp3DPVSigned, "", precision_);
  refittedTracksTab->addColumn<float>("ip3DPVSignedErr", refittedTrackIp3DPVSignedErr, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBS", refittedTrackDxyBS, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBSErr", refittedTrackDxyBSErr, "", precision_);
  refittedTracksTab->addColumn<float>("dzBS", refittedTrackDzBS, "", precision_);
  refittedTracksTab->addColumn<float>("dzBSErr", refittedTrackDzBSErr, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBSTraj", refittedTrackDxyBSTraj, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBSTrajErr", refittedTrackDxyBSTrajErr, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBSSigned", refittedTrackDxyBSSigned, "", precision_);
  refittedTracksTab->addColumn<float>("dxyBSSignedErr", refittedTrackDxyBSSignedErr, "", precision_);
  refittedTracksTab->addColumn<float>("ip3DBSSigned", refittedTrackIp3DBSSigned, "", precision_);
  refittedTracksTab->addColumn<float>("ip3DBSSignedErr", refittedTrackIp3DBSSignedErr, "", precision_);
