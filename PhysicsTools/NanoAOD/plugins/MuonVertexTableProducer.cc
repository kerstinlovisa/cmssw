...
void MuonVertexTableProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
  ...
  for (const auto& [key, table] : vertexTables) {
    table->addColumn<float>("isValid", vertexIsValid[key], "", precision_);
    table->addColumn<float>("vxy", vxy[key], "", precision_);
    table->addColumn<float>("vxySigma", vxySigma[key], "", precision_);
    table->addColumn<float>("vxyz", vxyz[key], "", precision_);
    table->addColumn<float>("vxyzSigma", vxyzSigma[key], "", precision_);
    table->addColumn<float>("chi2", chi2[key], "", precision_);
    table->addColumn<float>("ndof", ndof[key], "", precision_);
    table->addColumn<float>("normChi2", normChi2[key], "", precision_);
    table->addColumn<float>("vx", vx[key], "", precision_);
    table->addColumn<float>("vy", vy[key], "", precision_);
    table->addColumn<float>("vz", vz[key], "", precision_);
    table->addColumn<float>("t", t[key], "", precision_);
    table->addColumn<float>("vxErr", vxErr[key], "", precision_);
    table->addColumn<float>("vyErr", vyErr[key], "", precision_);
    table->addColumn<float>("vzErr", vzErr[key], "", precision_);
    table->addColumn<float>("tErr", tErr[key], "", precision_);
    table->addColumn<float>("dR", dR[key], "", precision_);
    table->addColumn<float>("originalMuonIdx1", originalMuonIdx1[key], "", precision_);
    table->addColumn<float>("originalMuonIdx2", originalMuonIdx2[key], "", precision_);
    table->addColumn<float>("isDSAMuon1", isDSAMuon1[key], "", precision_);
    table->addColumn<float>("isDSAMuon2", isDSAMuon2[key], "", precision_);
    table->addColumn<float>("displacedTrackIso03Dimuon1", displacedTrackIso03Dimuon1[key], "", precision_);
    table->addColumn<float>("displacedTrackIso04Dimuon1", displacedTrackIso04Dimuon1[key], "", precision_);
    table->addColumn<float>("displacedTrackIso03Dimuon2", displacedTrackIso03Dimuon2[key], "", precision_);
    table->addColumn<float>("displacedTrackIso04Dimuon2", displacedTrackIso04Dimuon2[key], "", precision_);
    table->addColumn<float>("displacedTrackIso03Muon1", displacedTrackIso03Muon1[key], "", precision_);
    table->addColumn<float>("displacedTrackIso04Muon1", displacedTrackIso04Muon1[key], "", precision_);
    table->addColumn<float>("displacedTrackIso03Muon2", displacedTrackIso03Muon2[key], "", precision_);
    table->addColumn<float>("displacedTrackIso04Muon2", displacedTrackIso04Muon2[key], "", precision_);
    table->addColumn<float>("dRprox", proxDeltaR[key], "", precision_);
    table->addColumn<float>("dca", DCA[key], "", precision_);
    table->addColumn<float>("dcaStatus", DCAstatus[key], "", precision_);
    table->addColumn<float>("dcax", DCAx[key], "", precision_);
    table->addColumn<float>("dcay", DCAy[key], "", precision_);
    table->addColumn<float>("dcaz", DCAz[key], "", precision_);
    table->addColumn<float>("hitsInFrontOfVert1", hitsInFrontOfVert1[key], "", precision_);
    table->addColumn<float>("hitsInFrontOfVert2", hitsInFrontOfVert2[key], "", precision_);
    table->addColumn<float>("missHitsAfterVert1", missHitsAfterVert1[key], "", precision_);
    table->addColumn<float>("missHitsAfterVert2", missHitsAfterVert2[key], "", precision_);
    table->addColumn<float>("refittedTrackIdx1", refittedTrackIdx1[key], "", precision_);
    table->addColumn<float>("refittedTrackIdx2", refittedTrackIdx2[key], "", precision_);
    table->addColumn<float>("refittedTrackIso03Dimuon1", refittedTrackIso03Dimuon1[key], "", precision_);
    table->addColumn<float>("refittedTrackIso04Dimuon1", refittedTrackIso04Dimuon1[key], "", precision_);
    table->addColumn<float>("refittedTrackIso03Dimuon2", refittedTrackIso03Dimuon2[key], "", precision_);
    table->addColumn<float>("refittedTrackIso04Dimuon2", refittedTrackIso04Dimuon2[key], "", precision_);
    table->addColumn<float>("refittedTrackIso03Muon1", refittedTrackIso03Muon1[key], "", precision_);
    table->addColumn<float>("refittedTrackIso04Muon1", refittedTrackIso04Muon1[key], "", precision_);
    table->addColumn<float>("refittedTrackIso03Muon2", refittedTrackIso03Muon2[key], "", precision_);
    table->addColumn<float>("refittedTrackIso04Muon2", refittedTrackIso04Muon2[key], "", precision_);
  }
  ...
  for (const auto& [key, table] : refittedTracksTables) {
    table->addColumn<float>("idx", refittedTrackIdx[key], "", precision_);
    table->addColumn<float>("isDSAMuon", refittedTrackIsDSAMuon[key], "", precision_);
    table->addColumn<float>("originalMuonIdx", refittedTrackOriginalIdx[key], "", precision_);
    table->addColumn<float>("pt", refittedTrackPt[key], "", precision_);
    table->addColumn<float>("ptErr", refittedTrackPtErr[key], "", precision_);
    table->addColumn<float>("px", refittedTrackPx[key], "", precision_);
    table->addColumn<float>("py", refittedTrackPy[key], "", precision_);
    table->addColumn<float>("pz", refittedTrackPz[key], "", precision_);
    table->addColumn<float>("eta", refittedTrackEta[key], "", precision_);
    table->addColumn<float>("etaErr", refittedTrackEtaErr[key], "", precision_);
    table->addColumn<float>("phi", refittedTrackPhi[key], "", precision_);
    table->addColumn<float>("phiErr", refittedTrackPhiErr[key], "", precision_);
    table->addColumn<float>("charge", refittedTrackCharge[key], "", precision_);
    table->addColumn<float>("normChi2", refittedTrackNormChi2[key], "", precision_);
    table->addColumn<float>("ndof", refittedTrackNdof[key], "", precision_);
    table->addColumn<float>("chi2", refittedTrackChi2[key], "", precision_);
    table->addColumn<float>("dzPV", refittedTrackDzPV[key], "", precision_);
    table->addColumn<float>("dzPVErr", refittedTrackDzPVErr[key], "", precision_);
    table->addColumn<float>("dxyPVTraj", refittedTrackDxyPVTraj[key], "", precision_);
    table->addColumn<float>("dxyPVTrajErr", refittedTrackDxyPVTrajErr[key], "", precision_);
    table->addColumn<float>("dxyPVSigned", refittedTrackDxyPVSigned[key], "", precision_);
    table->addColumn<float>("dxyPVSignedErr", refittedTrackDxyPVSignedErr[key], "", precision_);
    table->addColumn<float>("ip3DPVSigned", refittedTrackIp3DPVSigned[key], "", precision_);
    table->addColumn<float>("ip3DPVSignedErr", refittedTrackIp3DPVSignedErr[key], "", precision_);
  }
